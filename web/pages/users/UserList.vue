      ...
      >
        <template v-slot:body="props">
          <q-tr :props="props">
            ...
            <q-td key="createdAt" :props="props">{{props.row.created_at}}</q-td>
            <q-td key="updatedAt" :props="props">{{props.row.updated_at}}</q-td>
            <q-td key="ops" :props="props">
              <q-btn dense flat size="sm" icon="mdi-key-change" @click="resetPwd(props.row.email)" />
              <q-btn dense flat size="sm" icon="mdi-delete" @click="deleteUser(props.row.email)" />
            </q-td>
          </q-tr>
        </template>
      </q-table>
